...
// const _getCode = ({ mc, hc, code }) => {
//   const responseCode = new Number(`${Constants.SERVICE_CODE}${mc}${hc}${code}`);
...
// const _getError = (err) => {
//   if (!err) return {};
//   return { code: _getCode(err), message: _getStrError(err) };
// };
...
//   _500: { httpCode: 500, type: 'INTERNAL_SERVER_ERROR', code: 200, message: 'server error', ...UN_SUCCESS },
// };
